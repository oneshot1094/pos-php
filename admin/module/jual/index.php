											...
											<tbody>
												...
												<form method="POST" action="fungsi/edit/edit.php?jual=jual">
													...
													foreach($pelanggan as $p){;?>
															<option value="<?php echo $p['id_pelanggan']; ?>" <?php if($p['id_pelanggan'] == $isi['id_pelanggan']){echo 'selected';} ?>><?php echo $p['nama_pelanggan']; ?></option>	
													<?php }?>
														</select>			
													</td>
													<td>
										...
										<table class="table table-stripped">
												...
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														for($x=0;$x<$jumlah_dipilih;$x++){
															...
															$d = array($id_barang[$x],$id_member[$x],$id_pelanggan[$x],$jumlah[$x],$total[$x],$tgl_input[$x],$periode[$x]);
															$sql = "INSERT INTO nota (id_barang,id_member,id_pelanggan,jumlah,total,tanggal_input,periode) VALUES(?,?,?,?,?,?,?)";
											...
											<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
												<?php foreach($hasil_penjualan as $isi){;?>
													...
													<input type="hidden" name="id_pelanggan[]" value="<?php echo $isi['id_pelanggan'];?>">
												...
												<tr>
													<td>Total Semua  </td>
													<td><input type="text" class="form-control" name="total_bayar" value="<?php echo $total_bayar;?>"></td>
											...
											<tr>
												<td>Kembali</td>
												<td><input type="text" class="form-control" value="<?php echo $bayar - $total_bayar;?>"></td>
												<td></td>
												<td>
